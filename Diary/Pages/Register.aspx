<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="Diary.Register" %>
            ...
            <div class="col-sm-4">
                ...
                <div class="row">
                   <form id="form1" runat="server">
                        ...
                        <div class="form-group">
                            <asp:Label runat="server" ID="Label5" AssociatedControlID="txtPassword" Text="Password"></asp:Label>
                            <asp:TextBox CssClass="form-control" runat="server" ID="txtPassword" TextMode="Password" placeholder="Enter Password"></asp:TextBox>
                        </div>
                        <div class="form-group">
                            <asp:Button ID="Button1" CssClass="btn btn-success" runat="server" Text="Register" OnClick="Button1_Click" Font-Size="Medium" />
                        </div>
                    </form>
                    <div class="row" style="padding: 5px"></div>
                    <div class="text-center form-group">
                        <asp:HyperLink runat="server" NavigateUrl="Login.aspx" Text="Already a member? Login here." CssClass="form-control"></asp:HyperLink>
                    </div>
                </div>
            </div>
        </div>
