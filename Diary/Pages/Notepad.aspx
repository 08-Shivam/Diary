<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Notepad.aspx.cs" Inherits="Diary.Pages.Notepad" %>
                            ...
                            <div class="col-sm-12">
                                <div class="row">
                                    <div class="col-sm-10" style="display: flex; justify-content: center; align-items: center">
                                        <asp:TextBox CssClass="form-control" runat="server" ID="lblCreate" placeholder="Enter File Name..." Style="margin-top: 20px;"></asp:TextBox>
                                        ...
                                        <asp:LinkButton ID="btnClose" runat="server" Text="Close" CssClass="btn btn-warning" OnClick="btnClose_Click" PostBackUrl="~/Pages/Notepad.aspx" Style="margin-top: 20px;" />
                                    </div>
